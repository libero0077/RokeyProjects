...
{
  new (message_memory) menu_order_interfaces::msg::Order(_init);
}

void Order_fini_function(void * message_memory)
{
  auto typed_message = static_cast<menu_order_interfaces::msg::Order *>(message_memory);
  typed_message->~Order();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Order_message_member_array[3] = {
  {
    ...
    offsetof(menu_order_interfaces::msg::Order, table_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(menu_order_interfaces::msg::Order, menu),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(menu_order_interfaces::msg::Order, quantity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Order_message_members = {
  "menu_order_interfaces::msg",  // message namespace
  "Order",  // message name
  3,  // number of fields
  sizeof(menu_order_interfaces::msg::Order),
...
{
  return &::menu_order_interfaces::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, menu_order_interfaces, msg, Order)() {
  return &::menu_order_interfaces::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
