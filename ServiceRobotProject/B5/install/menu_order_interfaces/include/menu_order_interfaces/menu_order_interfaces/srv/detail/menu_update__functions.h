...
#ifndef MENU_ORDER_INTERFACES__SRV__DETAIL__MENU_UPDATE__FUNCTIONS_H_
#define MENU_ORDER_INTERFACES__SRV__DETAIL__MENU_UPDATE__FUNCTIONS_H_
...
/// Initialize srv/MenuUpdate message.
/**
...
/// Finalize srv/MenuUpdate message.
/**
...
/// Create srv/MenuUpdate message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * menu_order_interfaces__srv__MenuUpdate_Request__init().
...
/// Destroy srv/MenuUpdate message.
/**
 * It calls
 * menu_order_interfaces__srv__MenuUpdate_Request__fini()
...
/// Check for srv/MenuUpdate message equality.
/**
...
/// Initialize array of srv/MenuUpdate messages.
/**
...
/// Finalize array of srv/MenuUpdate messages.
/**
 * It calls
 * menu_order_interfaces__srv__MenuUpdate_Request__fini()
...
/// Create array of srv/MenuUpdate messages.
/**
 * It allocates the memory for the array and calls
 * menu_order_interfaces__srv__MenuUpdate_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MenuUpdate messages.
/**
 * It calls
 * menu_order_interfaces__srv__MenuUpdate_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MenuUpdate message array equality.
/**
...
/// Copy an array of srv/MenuUpdate messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * menu_order_interfaces__srv__MenuUpdate_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_menu_order_interfaces
...
/**
 * It calls
 * menu_order_interfaces__srv__MenuUpdate_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_menu_order_interfaces
...
/**
 * It allocates the memory for the array and calls
 * menu_order_interfaces__srv__MenuUpdate_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_menu_order_interfaces
...
/**
 * It calls
 * menu_order_interfaces__srv__MenuUpdate_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MENU_ORDER_INTERFACES__SRV__DETAIL__MENU_UPDATE__FUNCTIONS_H_
